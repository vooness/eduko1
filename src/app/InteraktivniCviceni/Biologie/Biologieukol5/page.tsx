...
export default function BiologieUkol5Page() {
  return (
    <div className="bg-gray-900 text-white min-h-screen flex flex-col">
      ...
      <div className="flex-grow p-6 flex flex-col items-center mt-28 mb-28">
        <div className="max-w-4xl w-full text-center mb-10">
          <h1 className="text-5xl font-extrabold text-white mb-4">Biologie - Úkol 5</h1>
        ...
        <div className="w-full max-w-3xl bg-white rounded shadow-lg p-6">
          <iframe
            src="https://i-eduko.h5p.com/content/1292494157050467607/embed"
            aria-label="Biologie Úkol 5"
            width="100%"
            height="637"
            frameBorder="0"
            allowFullScreen={true}
            allow="autoplay *; geolocation *; microphone *; camera *; midi *; encrypted-media *"
            title="Biologie Úkol 5"
          ></iframe>
        </div>
      </div>
